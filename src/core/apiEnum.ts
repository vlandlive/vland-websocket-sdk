export enum ServerPush {
    ...
    PrepareGameRoute = "PrepareGame",        // 用户准备赛车游戏
    TriggerInteractiveObjectRoute = "TriggerInteractiveObject", // 赛车碰撞交互物
    FinishGameRoute = "FinishGame",         // 用户完成赛车游戏 通知API更新排行榜
    GameTriggerSpecialAreaRoute = "GameTriggerSpecialArea", // 游戏触发特殊区域
    GameTriggerInteractiveRoute = "GameTriggerInteractive", // 游戏触发特殊交互物
    OpenVideo = 'OpenVideo',//机器人出入对方视野
...
export type ServerConfig = "eventId" | "spaceId" | "apiId"
